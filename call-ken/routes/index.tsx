...
import { createAudio, sounds } from "@/call-ken/lib/audio";
import {
  RealtimeAgent,
  RealtimeItem,
  RealtimeSession,
...
import { MessageItem } from "@/call-ken/components/application/messaging/messaging";
import { AgentSpeakingAvatar } from "@/call-ken/components/agent-speaking-avatar";
import { MessageActionTextarea } from "@/call-ken/components/send-message";
import { convertFileToBase64 } from "@/call-ken/lib/utils";
                    ...
                    const messages: SavedMessage[] = event
                      ...
                      .map((item) => {
                        const extractedText = item.content
                          .map((c: { type: string; transcript?: string; text?: string }) => {
                            if (
                              c.type === "input_audio" ||
                              c.type === "output_audio"
                            ) {
