...
export type PartContentMap = {
    part1?: Part1TableContentData | Part1Table4ColContentData | Part1NotesContentData | Part1TablePlusNotesContentData;
...
const cambridge20Content: Record<string, PartContentMap> = {
    "cambridge-20|test-1": {
            ...
            chooseTwoBlocks: [
                ...
                },
                {
                    ...
                    options: [
                        ...
                        { letter: "E", text: "Some are available for use by participants." },
                    ],
                    qNums: [19, 20],
                },
            ],
        ...
        part3: {
            chooseTwoBlocks: [
                {
                    instruction: "Choose TWO letters, A–E.",
                    question: "Which TWO things do the students both believe are responsible for the increase in loneliness?",
                    options: [
                ...
                {
                    instruction: "Choose TWO letters, A–E.",
                    question: "Which TWO health risks associated with loneliness do the students agree are based on solid evidence?",
                    options: [
                ...
                {
                    instruction: "Choose TWO letters, A–E.",
                    question: "Which TWO opinions do both the students express about the evolutionary theory of loneliness?",
                    options: [
                ...
                questions: [
                    {
                        ...
                        options: [
                            { letter: "A", text: "Doubt that there will ever be a medical cure for loneliness." },
                            { letter: "B", text: "Claim that the link between loneliness and mental health is overstated." },
                            { letter: "C", text: "Express frustration that loneliness is not taken more seriously." },
                        ],
                    },
                    {
                        qNum: 28,
                        ...
                        options: [
                            { letter: "A", text: "To explain how difficult loneliness can be" },
                            { letter: "B", text: "To highlight a situation that most students will recognise" },
                            { letter: "C", text: "To emphasise that feeling lonely is more common for men than women" },
                        ],
                    },
                    {
                        qNum: 29,
    ...
    "cambridge-20|test-4": {
        ...
        part2: {
            ...
            matching: {
                instruction: "Which event in the history of football in the UK took place in each of the following years? Choose SIX answers from the box and write the correct letter, A–H, next to questions 15–20.",
        ...
        part3: {
            chooseTwoBlocks: [
                {
                    instruction: "Choose TWO letters, A–E",
                    question: "Which TWO benefits for children of learning to write did both students find surprising?",
                    options: [
                ...
                {
                    instruction: "Choose TWO letters, A–E",
                    question: "For children with dyspraxia, which TWO problems with handwriting do the students think are easiest to correct?",
                    options: [
    ...
    "cambridge-20|test-2": {
        ...
        part2: {
            matchingRole: {
                instruction: "What is the role of the volunteers in each of the following activities? Choose SIX answers from the box and write the correct letter, A–I, next to Questions 11–16.",
                ...
                options: [
                    ...
                    { letter: "H", text: "encouraging cooperation between local organisations" },
        ...
        part3: {
            matching: {
                instruction: "What is Rosie and Colin's opinion about each of the following aspects of human geography? Choose FIVE answers from the box and write the correct letter, A–G, next to Questions 21–25.",
                options: [
                    { letter: "A", text: "The information given about this was too vague." },
                    { letter: "B", text: "This may not be relevant to their course." },
                    { letter: "C", text: "This will involve only a small number of statistics." },
                    ...
                    { letter: "G", text: "The information provided about this was interesting." },
                ],
                items: [
    ...
    "cambridge-20|test-3": {
        ...
        part2: {
            ...
            mapLabeling: {
                ...
                imageUrl: "https://i0.wp.com/engnovate.com/wp-content/uploads/2025/07/cambridge-ielts-20-academic-reading-test-3%E2%80%9317-20.png?w=690&ssl=1",
            },
        },
        part3: {
            singleChoice: {
            ...
            matching: {
                instruction: "What comment is made about the programme for each of the following shows? Choose FOUR answers from the box and write the correct letter, A–F, next to Questions 27–30.",
                options: [
                    { letter: "A", text: "Its origin is somewhat controversial" },
        ...
        questions: [
            ...
            },
            {
                ...
                options: [
                    ...
                    { letter: "C", text: "should only be developed for essential products." },
                ],
            },
            {
                qNum: 33,
...
export function getPartContent(setId: string, testId: string): PartContentMap {
    ...
    if (override && Object.keys(override).length > 0) {
        result = {
            ...
            ...(override.part2 && {
                part2: { ...(base.part2 as object), ...override.part2 } as PartContentMap["part2"],
            }),
            ...(override.part3 && {
                part3: { ...(base.part3 as object), ...override.part3 } as PartContentMap["part3"],
            }),
        };
    }
    if (key === "cambridge-10|test-4") {
        ...
        const cam1019 = listeningPartContentCam1019[key as keyof typeof listeningPartContentCam1019];
        if (cam1019?.part4) {
            result = {
                ...result,
...
export function getChooseTwoBlocksForPart(partContent: PartContentMap, part: 2 | 3): ChooseTwoBlock[] | undefined {
    if (part === 2)
