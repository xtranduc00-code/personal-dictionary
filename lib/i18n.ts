...
export const translations = {
  en: {
    ...
    notesFolderManageHint:
      "Rename or delete folders. Deleting a folder does not delete your notes—they become uncategorized.",
  ...
  vi: {
    ...
    notesFolderManageHint:
      "Đổi tên hoặc xóa thư mục. Xóa thư mục không xóa ghi chú—chúng chuyển sang chưa phân loại.",
