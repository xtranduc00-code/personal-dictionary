...
export const translations = {
  en: {
    ...
    studyScheduleManagePeople: "People",
    studyScheduleManageModalTitle: "Manage people (paint brushes)",
    studyScheduleManageEmpty: "No people yet — add one to start painting.",
    studyScheduleManageAddPerson: "Add person",
    studyScheduleManageNamePlaceholder: "Name",
    studyScheduleManageColorLabel: "Color",
    studyScheduleManageDelete: "Delete",
    studyScheduleManageSave: "Save",
    studyScheduleManageCancel: "Cancel",
    studyScheduleManageDuplicateName: "Name already used",
    studyScheduleManageEmptyName: "Name is required",
    studyScheduleManageNoBrushHint:
      "Add at least one person in Manage to start painting.",
    ...
    dailyNewsSourceEngoo: "Daily News",
    ...
    notesFolderMenuPdf: "Upload PDF",
    notesPdfOnlyError: "Only .pdf files are allowed.",
    notesPdfUploading: "Uploading PDF…",
    notesPdfUploaded: "PDF uploaded.",
    notesPdfUploadFailed: "Couldn’t upload the PDF.",
  ...
  vi: {
    ...
    studyScheduleManagePeople: "Người",
    studyScheduleManageModalTitle: "Quản lý người (màu tô)",
    studyScheduleManageEmpty: "Chưa có ai — thêm một người để bắt đầu tô.",
    studyScheduleManageAddPerson: "Thêm người",
    studyScheduleManageNamePlaceholder: "Tên",
    studyScheduleManageColorLabel: "Màu",
    studyScheduleManageDelete: "Xóa",
    studyScheduleManageSave: "Lưu",
    studyScheduleManageCancel: "Hủy",
    studyScheduleManageDuplicateName: "Tên đã được dùng",
    studyScheduleManageEmptyName: "Cần nhập tên",
    studyScheduleManageNoBrushHint:
      "Thêm ít nhất một người trong Quản lý để bắt đầu tô.",
    ...
    notesFolderMenuPdf: "Tải PDF lên",
    notesPdfOnlyError: "Chỉ chấp nhận tệp .pdf.",
    notesPdfUploading: "Đang tải PDF lên…",
    notesPdfUploaded: "Đã tải PDF lên.",
    notesPdfUploadFailed: "Không tải được PDF lên.",
