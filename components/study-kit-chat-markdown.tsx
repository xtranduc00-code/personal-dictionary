...
const root =
    ...
    "[&_pre]:my-2 [&_pre]:max-h-48 [&_pre]:overflow-auto [&_pre]:rounded-md [&_pre]:border [&_pre]:border-zinc-200/80 [&_pre]:bg-zinc-50 [&_pre]:p-2 [&_pre]:text-[12px] dark:[&_pre]:border-white/10 dark:[&_pre]:bg-zinc-900/80";
